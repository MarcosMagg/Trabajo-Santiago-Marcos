...
namespace Trabajo_Santiago_Marcos.Repository
{
    public partial class ReservaRestaurantContext : DbContext
    {
        public ReservaRestaurantContext()
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdRangoReserva)
                    .HasName("PK__rango_re__E110E7BB0283C7D4");
            ...
            {
                entity.HasKey(e => e.CodReserva)
                    .HasName("PK__reserva__12EE26868E8721C5");
                ...
                entity.HasOne(d => d.IdRangoReservaNavigation)
